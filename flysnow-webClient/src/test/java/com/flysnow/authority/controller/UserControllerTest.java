...
public class UserControllerTest extends BaseTest {
    ...
    public void testGetListForPage() throws Exception {
        ...
        map.put("pageNo", "1");
        map.put("pageSize", "10");
        String result = performPost("/user/getListForPage", map);
    ...
    public void testGetList() throws Exception {
        ...
        String result = performPost("/user/getList", data);
    ...
    public void testInsert() throws Exception {
        Map<String, Object> dataMap = new HashMap<>();
        String data = JsonUtils.objectToJson(dataMap);
        String result = performPost("/user/insert", data);
        logger.info("返回结果：" + result);
    }
	...
	public void testGet() throws Exception {
        Map<String, Object> dataMap = new HashMap<>();
        String data = JsonUtils.objectToJson(dataMap);
        String result = performPost("/user/get", data);
        logger.info("返回结果：" + result);
	}
