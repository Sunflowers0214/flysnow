...
public class UserRoleControllerTest extends BaseTest {
    ...
    public void testGetListForPage() throws Exception {
        ...
        map.put("pageNo", "1");
        map.put("pageSize", "10");
        String result = performPost("/userRole/getListForPage", map);
    ...
    public void testGetList() throws Exception {
        ...
        String result = performPost("/userRole/getList", data);
    ...
    public void testInsert() throws Exception {
        Map<String, Object> dataMap = new HashMap<>();
        String data = JsonUtils.objectToJson(dataMap);
        String result = performPost("/userRole/insert", data);
        logger.info("返回结果：" + result);
    }
	...
	public void testGet() throws Exception {
        Map<String, Object> dataMap = new HashMap<>();
        String data = JsonUtils.objectToJson(dataMap);
        String result = performPost("/userRole/get", data);
        logger.info("返回结果：" + result);
	}
