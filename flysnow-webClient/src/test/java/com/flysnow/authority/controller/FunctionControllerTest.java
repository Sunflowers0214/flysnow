...
public class FunctionControllerTest extends BaseTest {
    ...
    public void testGetListForPage() throws Exception {
        ...
        map.put("pageNo", "2");
        map.put("pageSize", "5");
        String result = performPost("/function/getListForPage", map);
    ...
    public void testGetList() throws Exception {
        ...
        String result = performPost("/function/getList", data);
    ...
    public void testInsert() throws Exception {
        Map<String, Object> dataMap = new HashMap<>();
        String data = JsonUtils.objectToJson(dataMap);
        String result = performPost("/function/insert", data);
        logger.info("返回结果：" + result);
    }
	...
	public void testGet() throws Exception {
        Map<String, Object> dataMap = new HashMap<>();
        String data = JsonUtils.objectToJson(dataMap);
        String result = performPost("/function/get", data);
        logger.info("返回结果：" + result);
	}
